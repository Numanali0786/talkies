            ...
            <Box p={1.5} sx={{
                ...
                <Stack spacing={2}>
                    <Stack p={2} direction={'row'} spacing={3} alignItems={'center'} sx={{
                        ...
                        <Image size={48} />
                        <Typography variant='caption' >ass.png</Typography>
                        <IconButton>
                            <DownloadSimple />
                        </IconButton>
                    </Stack>
    ...
    return (
        <Stack direction={'row'} justifyContent={el.incoming ? 'start' : 'end'}>
            <Box p={1.5} sx={{
                ...
                <Stack spacing={2}>
                    <Stack p={2} direction={'column'} spacing={3} alignItems={'start'} sx={{
                        backgroundColor: theme.palette.background.paper,
                        borderRadius: 1
                    }} >
                        ...
                        <Stack spacing={2}>
                            ...
                            <Typography variant='subtitle2' component={Link}>www.yt.com</Typography>
                        </Stack>
                        <Typography variant='body2' color={el.incoming ? theme.palette.text : '#fff'}>{el.message}</Typography>
    ...
    return (
        <Stack direction={'row'} justifyContent={el.incoming ? 'start' : 'end'}>
            <Box p={1.5} sx={{
                ...
                <Stack spacing={2}>
                    <Stack p={2} direction={'column'} spacing={2} alignItems={'center'} sx={{
                        backgroundColor: theme.palette.background.paper,
                        borderRadius: 1
                    }} >
